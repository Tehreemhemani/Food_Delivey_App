        ...
        <ScrollView>
          <View style={styles.header}>
            <Image
              ...
              source={{ uri: "https://i.ndtvimg.com/i/2017-10/junk-food-is-twice-as-distracting-as-healthy-food_650x400_51509351098.jpg" }}
            />
          </View>
                  ...
                  <TouchableOpacity key={item.id}
                    onPress={() => {
                      ...
                      if (this.state.minimum_quantity[id] !== null) {
                        const check = item.filter(item => items.checked ? items : null);
